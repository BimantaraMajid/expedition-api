...
module.exports = {
    ...
    await queryInterface.bulkInsert('packages', [
      {
        ...
        customer_attribute: JSON.stringify({
          Nama_Sales: 'Radit Fitrawikarsa',
          TOP: '14 Hari',
          Jenis_Pelanggan: 'B2B',
        }),
        connote: JSON.stringify({
          connote_id: 'f70670b1-c3ef-4caf-bc4f-eefa702092ed',
          connote_number: 1,
          connote_service: 'ECO',
        ...
        destination_data: JSON.stringify({
  ...
  down: async (queryInterface) => queryInterface.bulkDelete('packages', null, {}),
